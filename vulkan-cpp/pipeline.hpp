...
namespace vk {
    ...
    /*
        Draft #2 -- Shader Modules, Vertex Attributes, Offload to VkPipeline Usage
        std::array<vk::shader_source, 2> shader_sources = {
            ...
            // Eventually when we do deal with compute shaders (todo in the future)
            vk::shader_source{
                .filename = "some_path/test_shader.comp.spv",
        ...
        vk::pipeline_info pipeline_resource_info = {
            .shader_modules = geo_res.handlers(), // return std::span<VkShaderModule>
            .vertex_attributes = geo_res.attributes() // return std::span<vertex_attribute>
        };
    ...
    */
     ...
     * @param shader_modules is a std::span<VkShaderModule> of the loaded shader sources for the pipeline to correspond to
     * @param descriptor_layouts are the VkDescriptorSetLayout that you pass up front to the graphics pipeline if there are any provided
    */

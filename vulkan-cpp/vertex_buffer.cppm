    ...
    inline namespace v1 {
        ...
        public:
            ...
            vertex_buffer(const VkDevice& p_device,
                ...
                // uint32_t buffer_usage = buffer_usage::transfer_src_bit | buffer_usage::storage_buffer_bit;
                ...
                m_vertex_handler = buffer_stream(m_device, p_vertices.size_bytes(), vertex_params);
                ...
                copy_command_buffer.copy_buffer(staging_buffer, m_vertex_handler, p_vertices.size_bytes());

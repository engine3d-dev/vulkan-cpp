...
namespace vk {
    ...
    public:
         ...
         * 
         * The command buffer that is executing these commands must be a specified primary command buffer
         * 
         * @param p_commands is the secondary command buffer that gets executed if the command buffer itself is a primary command buffer
        */

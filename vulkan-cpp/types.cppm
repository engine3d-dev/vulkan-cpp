...
export namespace vk {
    inline namespace v1 {
        enum format : uint32_t {
            ...
            rgb32_sfloat =
              VK_FORMAT_R32G32B32_SFLOAT, // Example from prompt:
         ...
         *
         * Defines the configuration for the VkPhysicalDevice handler to be
         * created with
         */
         ...
         * up front
         * @param views framebuffers provide the actual image views that will
         * serve as attachments to the renderpass handle
         * @param extent are for framebuffers to pass in frame image views to
         * the screen. Should be the size of the window viewport specified
         */
         ...
         * primary command buffers, allowing for more flexible resource
         * management
         */
         ...
         * meaning they will reset or be freed in a short time-frame. Flag may
         * also be used by implementation to control memory allocation behavior
         * within the pool
         *
         * @param reset represents
         * VK_COMMAND_POOL_CREATE_RESET_COMMAND_BUFFER_BIT
         *
         * Usage: Allows command buffers allocated from the pool to be
         * individually reset to their initial state; either by calling
         * vkResetCommandBuffer or implicit reset when calling
         ...
         * command buffers; meaning the the memory allocated with the command
         * pool is protected
         *
         *
         */
        enum command_pool_flags : uint32_t {
            transient =
              VK_COMMAND_POOL_CREATE_TRANSIENT_BIT, // represents
                                                    // VK_COMMAND_POOL_CREATE_TRANSIENT_BIT
            reset =
              VK_COMMAND_POOL_CREATE_RESET_COMMAND_BUFFER_BIT, // represents
                                                               // VK_COMMAND_POOL_CREATE_RESET_COMMAND_BUFFER_BIT
            protected_bit =
              VK_COMMAND_POOL_CREATE_PROTECTED_BIT, // represents
         ...
         * allocated from pool will be short-lived, meaning they'll reset or
         * freed quickly
         * @param VK_COMMAND_POOL_CREATE_RESET_COMMAND_BUFFER_BIT Allows
         * individual command buffers allocated from the pool to be reset to
         * their initial state using `vkResetCommandBuffer`
         * @param VK_COMMAND_POOL_CREATE_PROTECTED_BIT Designates command
         * buffers allocated from the pool as protective command buffers,
         * implying they are stored in protected memory and access to them is
        ...
        enum subpass_contents : uint32_t {
            inline_bit =
              VK_SUBPASS_CONTENTS_INLINE, // represents
                                          // VK_SUBPASS_CONTENTS_INLINE
            secondary_command =
              VK_SUBPASS_CONTENTS_SECONDARY_COMMAND_BUFFERS, // represents
                                                             // VK_SUBPASS_CONTENTS_SECONDARY_COMMAND_BUFFERS
            inline_and_secondary_command_khr =
              VK_SUBPASS_CONTENTS_INLINE_AND_SECONDARY_COMMAND_BUFFERS_EXT, // represents
                                                                            // VK_SUBPASS_CONTENTS_INLINE_AND_SECONDARY_COMMAND_BUFFERS_KHR
                                                                            // and
                                                                            // VK_SUBPASS_CONTENTS_INLINE_AND_SECONDARY_COMMAND_BUFFERS_EXT
            max_enum_content =
              VK_SUBPASS_CONTENTS_MAX_ENUM // represents
        ...
        enum class image_layout : uint32_t {
            ...
            depth_stencil_read_only_optimal =
              VK_IMAGE_LAYOUT_DEPTH_READ_ONLY_STENCIL_ATTACHMENT_OPTIMAL, // VK_IMAGE_LAYOUT_DEPTH_STENCIL_ATTACHMENT_READ_ONLY_OPTIMAL
            present_src_khr =
        ...
        enum buffer : uint8_t {
            ...
            storage =
              VK_DESCRIPTOR_TYPE_STORAGE_BUFFER, // represents
                                                 // VK_DESCRIPTOR_TYPE_STORAGE_BUFFER
            combined_image_sampler =
              VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER, // represents
                                                         // VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER
            sampled_only_image =
              VK_DESCRIPTOR_TYPE_SAMPLED_IMAGE // represents
         ...
         *
         * instance - refers to data entry per-instance. Specifying to the GPU
         * that the data entry in the buffer is to be after the instance of the
         * object itself.
         *         - Typically used for instanced rendering. Specfying next
         * entry of data to be after instanced drawn, could be shared. Therefore
         * instance is an option to choose from if vertex data is across as a
         * per-instance basis.
        ...
        enum class pipeline_stage_flags : uint32_t {
            ...
            tesselation_control_shader_bit =
              VK_PIPELINE_STAGE_TESSELLATION_CONTROL_SHADER_BIT,
         ...
         * under this one struct to represent both the VkAttachmentDescription
        ...
        enum command_usage : uint32_t {
            one_time_submit =
              VK_COMMAND_BUFFER_USAGE_ONE_TIME_SUBMIT_BIT, // Represents
                                                           // VK_COMMAND_BUFFER_USAGE_ONE_TIME_SUBMIT_BIT
            renderpass_continue_bit =
              VK_COMMAND_BUFFER_USAGE_RENDER_PASS_CONTINUE_BIT, // Represents
                                                                // VK_COMMAND_BUFFER_USAGE_RENDER_PASS_CONTINUE_BIT
            simulatneous_use_bit =
              VK_COMMAND_BUFFER_USAGE_SIMULTANEOUS_USE_BIT, // Represents
                                                            // VK_COMMAND_BUFFER_USAGE_SIMULTANEOUS_USE_BIT
            max_bit =
              VK_COMMAND_BUFFER_USAGE_FLAG_BITS_MAX_ENUM // Represents
